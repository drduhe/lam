...
def _allowed_sdpa_backends_context():
    """Context manager restricting SDPA to math, mem-efficient, and flash backends."""
    try:
        ...
        # PyTorch < 2.4: no torch.nn.attention; CUDA SDPA toggles are the closest analogue.
...
class SAM3VLBackbone(nn.Module):
    ...
    def forward_text(self, captions, input_boxes=None, additional_text=None, device=None):
        if device is None:
    ...
    def _forward_text_no_ack_ckpt(
        ...
        with _allowed_sdpa_backends_context():
