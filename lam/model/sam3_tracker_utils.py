"""``lam.model.sam3_tracker_utils`` — model utilities for LAM.
...
try:
    from lam.model.edt import edt_triton
...
def _get_connected_components_with_padding(mask):
    ...
    from lam.perflib.connected_components import connected_components
