"""Training loop orchestration: optimization steps, logging, and checkpointing."""
...
from lam.model.data_misc import BatchedDatapoint
from lam.model.model_misc import SAM3Output
from lam.model.utils.misc import copy_data_to_device
from lam.train.optim.optimizer import construct_optimizer
from lam.train.utils.checkpoint_utils import (
    assert_skipped_parameters_are_frozen,
    exclude_params_matching_unix_pattern,
    load_state_dict_into_model,
    with_check_parameter_frozen,
)
from lam.train.utils.distributed import all_reduce_max, barrier, get_rank
from lam.train.utils.freeze_utils import apply_freezing_from_config
from lam.train.utils.logger import Logger, setup_logging
from lam.train.utils.train_utils import (
    AverageMeter,
    DurationMeter,
    MemMeter,
    Phase,
