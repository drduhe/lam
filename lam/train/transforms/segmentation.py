"""``lam.train.transforms.segmentation`` — training utilities for LAM.
...
from lam.model.box_ops import masks_to_boxes
from lam.train.data.sam3_image_dataset import Datapoint
