"""``lam.model.sam3_tracking_predictor`` — model utilities for LAM.
...
from lam.model.sam3_tracker_base import NO_OBJ_SCORE, Sam3TrackerBase, concat_points
from lam.model.sam3_tracker_utils import fill_holes_in_mask_scores
from lam.model.utils.sam2_utils import load_video_frames
        ...
        if self.iter_use_prev_mask_pred:
            ...
            if prev_out is not None and prev_out["pred_masks"] is not None:
                prev_sam_mask_logits = prev_out["pred_masks"].to(
                    inference_state["device"], non_blocking=torch.cuda.is_available()
                )
