...
"""Matplotlib / OpenCV helpers for overlaying LAM / SAM3 masks, boxes, and video outputs.

Install optional dependencies::

    pip install -e ".[viz]"

Mirrors ``sam3.visualization_utils`` from the upstream SAM 3 repo for API parity.
"""
