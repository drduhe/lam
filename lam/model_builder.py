"""Factory functions that assemble the LAM / SAM3 image and video models.

Public entry: ``build_lam_image_model`` (re-exported from ``lam``)."""
...
from lam.model.decoder import (
    TransformerDecoder,
    TransformerDecoderLayer,
    TransformerDecoderLayerv2,
    TransformerEncoderCrossAttention,
)
from lam.model.encoder import TransformerEncoderFusion, TransformerEncoderLayer
from lam.model.geometry_encoders import SequenceGeometryEncoder
from lam.model.maskformer_segmentation import PixelDecoder, UniversalSegmentationHead
from lam.model.memory import (
    CXBlock,
    SimpleFuser,
...
from lam.model.model_misc import MultiheadAttentionWrapper as MultiheadAttention
from lam.model.model_misc import (
    TransformerWrapper,
    get_default_device,
)
from lam.model.necks import Sam3DualViTDetNeck
from lam.model.position_encoding import PositionEmbeddingSine
from lam.model.sam1_task_predictor import SAM3InteractiveImagePredictor
from lam.model.sam3_image import Sam3Image, Sam3ImageOnVideoMultiGPU
from lam.model.sam3_tracking_predictor import Sam3TrackerPredictor
from lam.model.sam3_video_inference import Sam3VideoInferenceWithInstanceInteractivity
from lam.model.sam3_video_predictor import Sam3VideoPredictor, Sam3VideoPredictorMultiGPU
from lam.model.text_encoder_ve import VETextEncoder
from lam.model.tokenizer_ve import SimpleTokenizer
from lam.model.vitdet import ViT
from lam.model.vl_combiner import SAM3VLBackbone
from lam.prompt_mask.transformer import RoPEAttention
...
def _create_sam3_model(
    ...
    matcher = None
    if not eval_mode:
        from lam.train.matcher import BinaryHungarianMatcherV2
...
def build_sam3_image_model(
    ...
    if bpe_path is None:
        bpe_path = str(files("lam").joinpath("assets", "bpe_simple_vocab_16e6.txt.gz"))
...
# Public LAM name: same architecture and checkpoints as `build_sam3_image_model`.
build_lam_image_model = build_sam3_image_model
