"""``lam.train.loss.loss_fns`` — training utilities for LAM.
...
from lam.model.data_misc import interpolate
from lam.train.loss.sigmoid_focal_loss import (
...
def sigmoid_focal_loss(
    ...
    # Triton backward uses (1 - p_t) ** (gamma - 1), which is invalid at gamma == 0.
