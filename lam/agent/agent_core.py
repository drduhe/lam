"""Multi-step agent loop coordinating LLM calls and SAM/LAM segmentation."""
    ...
    while generated_text is not None:
        ...
        if tool_call["name"] == "segment_phrase":
            ...
            for i in range(num_masks):
                ...
                image_w_mask_i_path = os.path.join(sam_output_dir, f"{sanitized_prompt}_selected_mask_{i + 1}.png")
