"""Triton implementation of batched 2D connected components (multi-phase DSU)."""
...
def connected_components_triton(input_tensor: torch.Tensor):
    ...
    _broadcast_sizes_kernel[grid_broadcast](output, sizes_histogram, component_sizes_out, numel, BLOCK_SIZE=BLOCK_SIZE)
