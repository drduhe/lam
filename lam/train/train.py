"""Distributed training entrypoint for SAM3 / LAM.

Parses configuration, builds datasets and model, and invokes the trainer loop."""
...
from lam.train.utils.train_utils import makedir, register_omegaconf_resolvers
...
if __name__ == "__main__":
    initialize_config_module("lam.train", version_base="1.2")
