"""``lam.model.sam1_task_predictor`` — model utilities for LAM.
...
from lam.model.sam3_tracker_base import Sam3TrackerBase
from lam.model.utils.sam1_utils import SAM2Transforms
