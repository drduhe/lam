"""``lam.model.sam3_tracker_base`` — model utilities for LAM.
...
from lam.model.memory import SimpleMaskEncoder
from lam.model.model_misc import tensor_to_device
from lam.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames
from lam.prompt_mask.mask_decoder import MLP, MaskDecoder
from lam.prompt_mask.prompt_encoder import PromptEncoder
from lam.prompt_mask.transformer import TwoWayTransformer
from lam.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _get_tpos_enc(self, rel_pos_list, device, max_abs_pos=None, dummy=False):
        ...
        pos_enc = tensor_to_device(torch.tensor(rel_pos_list), device) / t_diff_max
    ...
    def _compile_all_components(self):
        ...
        from lam.perflib.compile import compile_wrapper
