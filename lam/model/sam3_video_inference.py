"""``lam.model.sam3_video_inference`` — model utilities for LAM.
...
from lam import perflib
from lam.logger import get_logger
from lam.model.act_ckpt_utils import clone_output_wrapper
from lam.model.box_ops import box_xywh_to_cxcywh, box_xyxy_to_xywh
from lam.model.data_misc import BatchedDatapoint, FindStage, convert_my_tensors
from lam.model.geometry_encoders import Prompt
from lam.model.io_utils import IMAGE_EXTS, load_resource_as_video_frames
from lam.model.model_misc import tensor_to_device
from lam.model.sam3_tracker_utils import fill_holes_in_mask_scores
from lam.model.sam3_video_base import MaskletConfirmationStatus, Sam3VideoBase
from lam.model.utils.misc import copy_data_to_device
from lam.perflib.compile import compile_wrapper, shape_logging_wrapper
from lam.perflib.masks_ops import masks_to_boxes as perf_masks_to_boxes

logger = get_logger(__name__)


def _autocast_cuda_bf16(method):
    """CUDA bf16 autocast only when CUDA exists; avoids import-time cuda init from @torch.autocast."""
